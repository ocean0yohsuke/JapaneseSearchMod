...
class UTF8_JapaneseChar
{
	...
	{
		if ($char >= self::UTF8_HIRAGANA_FIRST && $char <= self::UTF8_HIRAGANA_LAST
		|| $char === 'ー')
		{
			return true;
		}
	...
	{
		if ($char >= self::UTF8_KATAKANA_FIRST && $char <= self::UTF8_KATAKANA_LAST
		|| $char >= self::UTF8_HANKAKUKATAKANA_FIRST && $char <= self::UTF8_HANKAKUKATAKANA_FIRST
		|| $char === '-')
		{
			return true;
		}

...
class JapaneseIndexerUtil {
	 ...
	 *        	PHP extension, eg. 'mbstring', 'mecab'
	 * @return bool
	 */
	static function loadExtension($extension) {
		...
		if ((! @ini_get ( 'enable_dl' ) && strtolower ( @ini_get ( 'enable_dl' ) ) != 'on') || (@ini_get ( 'safe_mode' ) && strtolower ( @ini_get ( 'safe_mode' ) ) != 'off') || ! function_exists ( 'dl' )) {
			return false;
		}

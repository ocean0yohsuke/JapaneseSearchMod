	...
	function main($referer) {
		...
		$display_vars = array (
				...
				'vars' => array (
						...
						'ext_encoding' => array (
								'lang' => 'JSM_MECAB_SETUP_EXT_ENCODING',
								'validate' => 'string',
								'type' => 'text:10:20',
								'explain' => true 
						),
						'ext_dicdir' => array (
								'lang' => 'JSM_MECAB_SETUP_EXT_DICDIR',
								'validate' => 'string',
								'type' => 'text:30:50',
								'explain' => true 
						),
						...
						'cli_encoding' => array (
								'lang' => 'JSM_MECAB_SETUP_CLI_ENCODING',
								'validate' => 'string',
								'type' => 'text:10:20',
								'explain' => true 
						),
						'cli_exepath' => array (
								'lang' => 'JSM_MECAB_SETUP_CLI_EXEPATH',
								'validate' => 'string',
								'type' => 'text:30:50',
								'explain' => true 
						) 
		...
		foreach ( $display_vars ['vars'] as $config_key => $vars ) {
			...
			if (strpos ( $config_key, 'legend' ) !== false) {
				...
				$wakachigakitest_result = (! isset ( $error_message )) ? '<strong style="color:green">' . $user->lang ['JSM_SUCCESSED'] . '</strong>' : '<strong style="color:red">' . $user->lang ['JSM_' . $error_message] . '</strong>';

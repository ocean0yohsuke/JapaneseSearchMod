	...
	function main()
	{
		...
		$display_vars = array(
			'vars'	=> array(
				...
				'wakachigaki_level'	=> array('lang' => 'JSM_PHPBB3NATIVE_CONFIG_WAKACHIGAKI_LEVEL', 'validate' => 'string', 'type' => 'select', 'object' => $this, 'method' => 'build_cfg_template_select_wakachigaki_level', 'explain' => true),
		));
